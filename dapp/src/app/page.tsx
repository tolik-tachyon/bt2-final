    ...
    const quickLinks = [
        {
            href: "/craft",
            label: "Craft a Pony",
            desc: "Burn elements, mint a pony NFT",
            color: "text-purple",
        },
        {
            href: "/amm",
            label: "Swap Tokens",
            desc: "Trade on the AMM marketplace",
            color: "text-green",
        },
        {
            href: "/vault",
            label: "Stake & Earn",
            desc: "Deposit GOV tokens, earn yield boost",
            color: "text-orange",
        },
        {
            href: "/dao",
            label: "Vote on Proposals",
            desc: "Govern protocol parameters",
            color: "text-accent",
        },
    ];
    ...
    return (
        <main className="max-w-7xl mx-auto px-4 py-8 flex flex-col gap-8 animate-fade-in">
                ...
                <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-subtext mt-1 font-body">
                            ERC-1155 on-chain item economy · craft · trade ·
                            govern
                        </p>
                        {isConnected && address && (
            ...
            <ConnectGuard>
                <Section
                    title="Portfolio"
                    sub="Wallet, voting, vault, and protocol state"
                >
                        ...
                        <StatCard
                            ...
                            value={
                                vaultShares !== undefined
                                    ? formatAmount(vaultShares as bigint)
                                    : "-"
                            }
                        />
                        <StatCard
                            ...
                            value={
                                pinkie !== undefined
                                    ? (pinkie as bigint).toString()
                                    : "-"
                            }
                            sub="ERC-1155 balance"
                        />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <StatCard
                            ...
                            value={
                                reserveA !== undefined
                                    ? formatAmount(reserveA as bigint)
                                    : "-"
                            }
                        />
                        <StatCard
                            ...
                            value={
                                reserveB !== undefined
                                    ? formatAmount(reserveB as bigint)
                                    : "-"
                            }
                            sub={
                                isRenting ? "NFT boost active" : "No NFT boost"
                            }
                        />
                    </div>
                </Section>
                        ...
                        <div className="grid md:grid-cols-2 gap-3">
                            <div className="card flex flex-col gap-3">
                                ...
                                {(activity?.swaps ?? []).map((swap) => (
                                    <div
                                        key={swap.id}
                                        className="flex items-center justify-between text-xs font-mono border-t border-border pt-2"
                                    >
                            ...
                            <div className="card flex flex-col gap-3">
                                ...
                                {activity && activity.crafts.length === 0 && (
                                    <p className="text-subtext text-xs font-mono">
                                        No indexed crafts yet.
                                    </p>
                                )}
                            </div>
                        </div>
                ...
                >
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
                        {quickLinks.map((link) => (
                            ...
                            >
                                <p
                                    className={`font-display font-semibold text-sm ${link.color}`}
                                >
                                    {link.label}
                                </p>
